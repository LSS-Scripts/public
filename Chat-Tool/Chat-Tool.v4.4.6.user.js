...
// @version      4.4.6
// @description  Kombiniert Messenger-Design (v3.0) mit Blocker & Ladefunktion (v3.5). Inkl. Schnellschalter & sichtbarem Ausblend-Zähler (Fix 3). NEU: Smiley-Auswahl im Eingabefeld (Position Fix).
...
(async function() {
        ...
        modal.innerHTML = `
            <div class="pro-chat-modal-content">
                <div class="pro-chat-modal-header">
                    <h3 style="margin: 0;">Chat-Einstellungen (Pro v4.4.6)</h3>
    ...
    // === STYLES (KOMBINIERT v4.4.6 - Smiley-Position Fix) ===
    const mergedStyles = `
        /* === EINSTELLUNGS-MODAL === */
