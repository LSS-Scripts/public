...
// @version      4.4.7
// @description  Kombiniert Messenger-Design (v3.0) mit Blocker & Ladefunktion (v3.5). Inkl. Schnellschalter & sichtbarem Ausblend-Zähler (Fix 3). NEU: Smiley-Auswahl & ASCII-Smiley-Konvertierung (v4.4.7).
...
(async function() {
    ...
    // --- Smilies für die Auswahl (NEU: v4.4.5) ---
        ...
        modal.innerHTML = `
            <div class="pro-chat-modal-content">
                <div class="pro-chat-modal-header">
                    <h3 style="margin: 0;">Chat-Einstellungen (Pro v4.4.7)</h3>
    ...
    // === STYLES (KOMBINIERT v4.4.7 - Smiley-Position Fix) ===
    const mergedStyles = `
        /* === EINSTELLUNGS-MODAL === */
