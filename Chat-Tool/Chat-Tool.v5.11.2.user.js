// ==UserScript==
// @name         LSS - Moderner Chat Pro & Status (v5.11.2 - Safety Fix)
// @namespace    http://tampermonkey.net/
// @version      5.11.2
// @description  Chat v4 Design + Smart Emoji Popup + Header Buttons + Working Safety Check.
...
(async function() {
    ...
    function openSafetyModal(onSuccess) {
        try {
            ...
            modal.className = 'pro-chat-safety-overlay'; // Dedicated class
            ...
            // Fail-safe: If modal fails, allow send
            onSuccess();
        }
    }
