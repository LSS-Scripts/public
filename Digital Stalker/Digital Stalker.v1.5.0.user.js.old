...
(function() {
    ...
    const css = `
        ...
        /* Modal Box - Maximale Breite erzwingen */
        #bm-modal-box {
            width: 98%; /* Fast Bildschirmbreite */
            max-width: none !important; /* Bootstrap killen */
            height: 95%;
        ...
        #bm-modal-body {
            ...
            width: 100% !important; /* Sicher ist sicher */
        }

        /* === DIE BRECHSTANGE === */

        /* 1. Wir greifen den Container direkt an */
    ...
    function loadAndShowModal(url, buildingName) {
        ...
        // HIER: Wir setzen die Klasse direkt, aber das CSS überschreibt ihre Regeln
