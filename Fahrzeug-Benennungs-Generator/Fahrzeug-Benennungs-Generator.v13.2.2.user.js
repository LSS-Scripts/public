    ...
    const MODULE_CONFIG = {
        ...
        luftrettung: {
            ...
            nameGenerator: function(isLarge = false) {
                if (isLarge) {
                    ...
                    const adjektive = ["Nasser", "Schwerer", "Plötzlicher", "Kühlender", "Entscheidender", "Punktgenauer", "Großflächiger"];
                    const namen = ["Bomber", "Regenmacher", "Wolkenbruch", "Monsun", "Sintflut", "Tsunami", "Wasserfall", "Katarakt", "Sturzbach", "Guss", "Schauer", "Niederschlag", "Fontäne", "Geysir", "Cloudbuster", "Fire-Bomber", "Water-Bomber", "Lösch-Ei", "Regen-Tanz", "Neptuns-Zorn", "Poseidons-Rache", "Thor's-Dusche", "Wald-Tränke", "Glut-Löscher", "Asche-Binder", "Rauch-Drücker", "Flammen-Tod", "Feuer-Ex", "Letzte-Ölung", "Der-große-Durstlöscher"];
                    ...
                    const adjektive = ["Fliegender", "Schwebender", "Schneller", "Göttlicher", "Himmlischer", "Stählerner", "Alleehender", "Donnernder", "Windiger", "Kreisender", "Steigender", "Majestätischer"];
        ...
        drohnen: {
            ...
            nameGenerator: function(isLarge = false) {
                ...
                const adjektive = ["Schwebender", "Leiser", "Digitaler", "Allsehender", "Gestochen-Scharfer", "Taktischer", "Unbemerkter", "Summender", "Neugieriger", "Pixeliger", "Versteckter", "Autonomer", "Schwirrender", "Kühler", "Windiger"];
        ...
        gefahrgut: {
            ...
            nameGenerator: function(isLarge = false) {
                ...
                const adjektive = ["Ätzender", "Giftiger", "Radioaktiver", "Dichter", "Sicherer", "Hermetischer", "Analytischer", "Gefährlicher", "Flüchtiger", "Instabiler", "Reaktiver", "Gekapselter", "Gemessener", "Gefilterter"];
        ...
        hubrettung: {
            ...
            nameGenerator: function(isLarge = false) {
                ...
                const adjektive = ["Langer", "Hoher", "Stählerner", "Ausgefahrener", "Hydraulischer", "Standfester", "Schwindelfreier", "Rettender", "Steiler", "Senkrechter", "Gelenkiger", "Massiver", "Eiserner", "Unbeugsamer"];
        ...
        schlauchwagen: {
            ...
            nameGenerator: function(isLarge = false) {
                ...
                const adjektive = ["Nasser", "Langer", "Rollender", "Durstiger", "Praller", "Gefüllter", "Undichter", "Gekuppelter", "Verknoteter", "Schwerer", "Flexibler", "Unendlicher", "Blauer", "Roter", "Gelber"];
